	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 texCoord6 = input.ase_texcoord9.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 Emission = ( texCUBE( _Cubemap, refract( ase_viewDirTS , tex2DNode5 , lerpResult21 ) ) * _TintColor ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord6 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner7 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord6);
				float2 panner8 = ( 1.0 * _Time.y * float2( 0,0.4 ) + texCoord6);
				float lerpResult9 = lerp( tex2D( _Refraction_Waviness, panner7 ).g , tex2D( _Refraction_Waviness, panner8 ).g , 0.5);
				float2 temp_output_13_0 = ( ( texCoord6 + ( _Refraction_Waviness_Intensity * lerpResult9 ) ) + ( _Refraction_UV_Add / 100.0 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float3 ase_viewVectorTS =  tanToWorld0 * ( _WorldSpaceCameraPos.xyz - WorldPosition ).x + tanToWorld1 * ( _WorldSpaceCameraPos.xyz - WorldPosition ).y  + tanToWorld2 * ( _WorldSpaceCameraPos.xyz - WorldPosition ).z;
				float3 ase_viewDirTS = normalize( ase_viewVectorTS );
				float2 texCoord6 = input.ase_texcoord7.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner7 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord6);
				float2 panner8 = ( 1.0 * _Time.y * float2( 0,0.4 ) + texCoord6);
				float lerpResult9 = lerp( tex2D( _Refraction_Waviness, panner7 ).g , tex2D( _Refraction_Waviness, panner8 ).g , 0.5);
				float2 temp_output_13_0 = ( ( texCoord6 + ( _Refraction_Waviness_Intensity * lerpResult9 ) ) + ( _Refraction_UV_Add / 100.0 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord6 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner7 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord6);
				float2 panner8 = ( 1.0 * _Time.y * float2( 0,0.4 ) + texCoord6);
				float lerpResult9 = lerp( tex2D( _Refraction_Waviness, panner7 ).g , tex2D( _Refraction_Waviness, panner8 ).g , 0.5);
				float2 temp_output_13_0 = ( ( texCoord6 + ( _Refraction_Waviness_Intensity * lerpResult9 ) ) + ( _Refraction_UV_Add / 100.0 ) );
...
Node;AmplifyShaderEditor.SamplerNode;10;-1593.737,-184.4941;Inherit;True;Property;_Refraction_Waviness;Refraction_Waviness;5;0;Create;True;0;0;0;False;0;False;-1;None;443af2a11bb01f845b4c6fcdd3ee2a6b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;12;-560.689,-170.3526;Inherit;True;Property;_Refraction;Refraction;1;0;Create;True;0;0;0;False;0;False;-1;None;747d3d4acd2ceb14aa048ae5cea5f566;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;47;180.7822,-643.6104;Inherit;True;Property;_Cubemap;Cubemap;10;0;Create;True;0;0;0;False;0;False;-1;None;df17c36dd0a391842bccaa3843230c58;True;0;False;white;Auto;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;64;946.5239,-21.58442;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=4F53D99A5D6785F02FCDF5725BE96D071CE0CD87