	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 texCoord2_g57 = input.texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MainTex = input.ase_texcoord9.xyz.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode3 = tex2D( _MainTex, uv_MainTex );
				
				float2 uv_NormalTex = input.ase_texcoord9.xyz.xy * _NormalTex_ST.xy + _NormalTex_ST.zw;
				...
				float2 uv_EmissiveTex = input.ase_texcoord9.xyz.xy * _EmissiveTex_ST.xy + _EmissiveTex_ST.zw;
				...
				float2 uv_DifOpacityMask = input.ase_texcoord9.xyz.xy * _DifOpacityMask_ST.xy + _DifOpacityMask_ST.zw;
				float lerpResult76 = lerp( 0.0 , _Opacity_Add , tex2D( _DifOpacityMask, uv_DifOpacityMask ).g);
				float2 uv_Opacity_MasterMask = input.ase_texcoord9.xyz.xy * _Opacity_MasterMask_ST.xy + _Opacity_MasterMask_ST.zw;
				...
				float3 Emission = ( ( ( tex2D( _EmissiveTex, uv_EmissiveTex ) * _EmissiveColor ) * _EmissionIntencity ) + ( texCUBE( _Cubemap, refract( ase_viewDirTS , tex2DNode2 , _RefractionCubemap ) ) * _FakeReflections ) ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input )
			{
				...
				float2 texCoord2_g57 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv1_g57 = texCoord2_g57;
				float VATSpeed1_g57 = _VATSpeed;
				sampler2D VAT1_g57 = _VAT;
				float OffsetScale1_g57 = _OffsetScale;
						 ...
						 ) : SV_TARGET
			{
				...
				float4 tex2DNode3 = tex2D( _MainTex, uv_MainTex );
				float2 uv_DifOpacityMask = input.ase_texcoord3.xy * _DifOpacityMask_ST.xy + _DifOpacityMask_ST.zw;
				float lerpResult76 = lerp( 0.0 , _Opacity_Add , tex2D( _DifOpacityMask, uv_DifOpacityMask ).g);
				float2 uv_Opacity_MasterMask = input.ase_texcoord3.xy * _Opacity_MasterMask_ST.xy + _Opacity_MasterMask_ST.zw;
				float clampResult77 = clamp( tex2D( _Opacity_MasterMask, uv_Opacity_MasterMask ).g , _Opacity_Min , 1.0 );
				float Opacity47 = ( ( ( tex2DNode3.a * _Opacity_Tex_Multiply ) + lerpResult76 ) * clampResult77 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_EmissiveTex = input.ase_texcoord4.xyz.xy * _EmissiveTex_ST.xy + _EmissiveTex_ST.zw;
				...
				float2 uv_DifOpacityMask = input.ase_texcoord4.xyz.xy * _DifOpacityMask_ST.xy + _DifOpacityMask_ST.zw;
				float lerpResult76 = lerp( 0.0 , _Opacity_Add , tex2D( _DifOpacityMask, uv_DifOpacityMask ).g);
				float2 uv_Opacity_MasterMask = input.ase_texcoord4.xyz.xy * _Opacity_MasterMask_ST.xy + _Opacity_MasterMask_ST.zw;
				float clampResult77 = clamp( tex2D( _Opacity_MasterMask, uv_Opacity_MasterMask ).g , _Opacity_Min , 1.0 );
				float Opacity47 = ( ( ( tex2DNode3.a * _Opacity_Tex_Multiply ) + lerpResult76 ) * clampResult77 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_DifOpacityMask = input.ase_texcoord2.xy * _DifOpacityMask_ST.xy + _DifOpacityMask_ST.zw;
				float lerpResult76 = lerp( 0.0 , _Opacity_Add , tex2D( _DifOpacityMask, uv_DifOpacityMask ).g);
				float2 uv_Opacity_MasterMask = input.ase_texcoord2.xy * _Opacity_MasterMask_ST.xy + _Opacity_MasterMask_ST.zw;
				float clampResult77 = clamp( tex2D( _Opacity_MasterMask, uv_Opacity_MasterMask ).g , _Opacity_Min , 1.0 );
				float Opacity47 = ( ( ( tex2DNode3.a * _Opacity_Tex_Multiply ) + lerpResult76 ) * clampResult77 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;95;238.9497,-298.748;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=6D8168B35CAE4B941D6DBF852419DC58B7177563