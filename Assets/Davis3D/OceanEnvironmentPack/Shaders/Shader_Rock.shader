	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord49 = input.ase_texcoord9.xy * temp_cast_1 + float2( 0,0 );
				...
				float2 texCoord50 = input.ase_texcoord9.xy * temp_cast_3 + float2( 0,0 );
				...
				float2 texCoord55 = input.ase_texcoord9.xy * temp_cast_4 + float2( 0,0 );
				float2 temp_cast_5 = (( _Sand_MASTER_UV_Scale * _SandNormalScale2 )).xx;
				float2 texCoord59 = input.ase_texcoord9.xy * temp_cast_5 + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float clampResult43 = clamp( ( ( ( clampResult248 * tex2DNode98.b ) * 2.0 ) * _SandAmount ) , 0.0 , 1.0 );
				float2 temp_cast_1 = (_SandMaskScale).xx;
				float2 texCoord49 = input.ase_texcoord5.xy * temp_cast_1 + float2( 0,0 );
				float lerpResult51 = lerp( 1.0 , tex2D( _SandMask, texCoord49 ).g , _SandMaskAmount);
				float temp_output_44_0 = ( clampResult43 * lerpResult51 );
				float4 lerpResult36 = lerp( ( lerpResult74 * ( tex2DNode2 * _DiffuseMultiply * _DiffuseBrightness ) ) , temp_output_250_0 , temp_output_44_0);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float clampResult43 = clamp( ( ( ( clampResult248 * tex2DNode98.b ) * 2.0 ) * _SandAmount ) , 0.0 , 1.0 );
				float2 temp_cast_1 = (_SandMaskScale).xx;
				float2 texCoord49 = input.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float lerpResult51 = lerp( 1.0 , tex2D( _SandMask, texCoord49 ).g , _SandMaskAmount);
				float temp_output_44_0 = ( clampResult43 * lerpResult51 );
				float4 lerpResult36 = lerp( ( lerpResult74 * ( tex2DNode2 * _DiffuseMultiply * _DiffuseBrightness ) ) , temp_output_250_0 , temp_output_44_0);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;263;0,60;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=801435FE1E6F095EA409CDC19BD02F73163BB2DE