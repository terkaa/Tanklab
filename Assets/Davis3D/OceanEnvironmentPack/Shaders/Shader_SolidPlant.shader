	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord279 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord279 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 UVMaster295 = ( texCoord279 * _MASTER_UVScale );
				float4 tex2DNode2 = tex2D( _Diffuse, UVMaster295 );
				float4 lerpResult345 = lerp( ( _ColorDiffuseMultiply * tex2DNode2 ) , _ColorDiffuseLerp , _Diffuse_Color_Lerp);
				float4 ClearDiffuse307 = lerpResult345;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord279 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 UVMaster295 = ( texCoord279 * _MASTER_UVScale );
				float4 tex2DNode2 = tex2D( _Diffuse, UVMaster295 );
				float4 lerpResult345 = lerp( ( _ColorDiffuseMultiply * tex2DNode2 ) , _ColorDiffuseLerp , _Diffuse_Color_Lerp);
				float4 ClearDiffuse307 = lerpResult345;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;357;0,60;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=25583862DB19D9DE7B631B6D8CA2F96423672437