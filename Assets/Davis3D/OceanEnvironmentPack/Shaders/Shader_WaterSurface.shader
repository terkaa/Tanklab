	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord355 = input.ase_texcoord9.xyz.xy * temp_cast_1 + float2( 0,0 );
				...
				float2 texCoord357 = input.ase_texcoord9.xyz.xy * temp_cast_3 + float2( 0,0 );
				...
				float2 texCoord359 = input.ase_texcoord9.xyz.xy * temp_cast_5 + float2( 0,0 );
				...
				float2 texCoord346 = input.ase_texcoord9.xyz.xy * temp_cast_7 + float2( 0,0 );
				...
				float2 texCoord344 = input.ase_texcoord9.xyz.xy * temp_cast_9 + float2( 0,0 );
				...
				float fresnelNdotV381 = dot( WorldNormal, ase_viewDirWS );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (( _MASTERSpeed * _WaterSpeed1 )).xx;
				float2 temp_cast_1 = (( _MASTERTiling * _WaterTile1 )).xx;
				float2 texCoord355 = input.ase_texcoord4.xyz.xy * temp_cast_1 + float2( 0,0 );
				float2 panner364 = ( 1.0 * _Time.y * temp_cast_0 + texCoord355);
				float2 temp_cast_2 = (( _MASTERSpeed * _WaterSpeed2 )).xx;
				float2 temp_cast_3 = (( _MASTERTiling * _WaterTile2 )).xx;
				float2 texCoord357 = input.ase_texcoord4.xyz.xy * temp_cast_3 + float2( 0,0 );
				float2 panner361 = ( 1.0 * _Time.y * temp_cast_2 + texCoord357);
				float2 temp_cast_4 = (( _MASTERSpeed * _WaterSpeed3 )).xx;
				float2 temp_cast_5 = (( _MASTERTiling * _WaterTile3 )).xx;
				float2 texCoord359 = input.ase_texcoord4.xyz.xy * temp_cast_5 + float2( 0,0 );
				float2 panner365 = ( 1.0 * _Time.y * temp_cast_4 + texCoord359);
				float2 temp_cast_6 = (( _MASTERSpeed * _WaterSpeed4 )).xx;
				float2 temp_cast_7 = (( _MASTERTiling * _WaterTile4 )).xx;
				float2 texCoord346 = input.ase_texcoord4.xyz.xy * temp_cast_7 + float2( 0,0 );
				float2 panner352 = ( 1.0 * _Time.y * temp_cast_6 + texCoord346);
				float2 temp_cast_8 = (( _MASTERSpeed * _WaterSpeed5 )).xx;
				float2 temp_cast_9 = (( _MASTERTiling * _WaterTile5 )).xx;
				float2 texCoord344 = input.ase_texcoord4.xyz.xy * temp_cast_9 + float2( 0,0 );
				float2 panner360 = ( 1.0 * _Time.y * temp_cast_8 + texCoord344);
				float3 temp_output_374_0 = BlendNormal( BlendNormal( UnpackNormalScale( tex2D( _WaterNorm, panner364 ), 1.0f ) , UnpackNormalScale( tex2D( _WaterNorm, panner361 ), 1.0f ) ) , BlendNormal( UnpackNormalScale( tex2D( _WaterNorm, panner365 ), 1.0f ) , BlendNormal( UnpackNormalScale( tex2D( _WaterNorm, panner352 ), 1.0f ) , UnpackNormalScale( tex2D( _WaterNorm, panner360 ), 1.0f ) ) ) );
				float3 lerpResult379 = lerp( temp_output_377_0 , temp_output_374_0 , _WaterNormIntensityClose);
				float3 lerpResult380 = lerp( temp_output_377_0 , temp_output_374_0 , _WaterNormIntensityFar);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;398;-241.3275,38.52937;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=F3878882CAE86A7230246084E193064CDFF68F7C